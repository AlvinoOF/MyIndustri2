...
class UsersModel extends Model
{
    ...
    public function getUser($id_user = null, $id_apps = null)
    {
        ...
        $builder->select('tbl_user.id_user as userid, ktp, nama, tempat_lahir, tgl_lahir, jenis_kelamin, alamat, tlp, email, npp, kontrak, role, tgl_mulai, tgl_selesai, jabatan, profil_img');
        if ($id_user != null) :
