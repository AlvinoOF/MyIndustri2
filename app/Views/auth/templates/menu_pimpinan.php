<ul class="side-menu">
    ...
    <li class="slide">
        <a class="side-menu__item" href="<?= base_url('admin'); ?>"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
            ...
            <span class="side-menu__label">Edit Profile</span></a>
    </li>
    ...
    <li class="slide">
        <a class="side-menu__item" data-toggle="slide" href="#">
            ...
            <span class="side-menu__label">Daftar Aplikasi</span><i class="angle fe fe-chevron-down"></i>
        </a>

        <ul class="slide-menu">
            <li class="sub-slide">
                <a class="sub-side-menu__item" href="<?= base_url('masterjenis'); ?>"><span class="sub-side-menu__label">Daftar Aplikasi</span></a>
            </li>
        </ul>
    </li>
